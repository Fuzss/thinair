package fuzs.thinair.forge.client;

import fuzs.puzzleslib.api.client.core.v1.ClientModConstructor;
import fuzs.puzzleslib.api.core.v1.ModLoaderEnvironment;
import fuzs.thinair.ThinAir;
import fuzs.thinair.client.ThinAirClient;
import fuzs.thinair.forge.integration.curios.ForgeCuriosClientIntegration;
...
public class ThinAirClientForge {
    ...
    private static void registerIntegrations() {
        if (ModLoaderEnvironment.INSTANCE.isModLoaded("curios")) {
            ForgeCuriosClientIntegration.registerCuriosRenderer();
        }
    }
}
