...
public class ModRegistry {
    ...
    public static final RegistryReference<Item> RESPIRATOR_ITEM = REGISTRY.registerItem("respirator", () -> new ArmorItem(RESPIRATOR_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Properties().durability(77)));
    ...
    public static final TagKey<Item> BREATHING_EQUIPMENT_ITEM_TAG = REGISTRY.registerItemTag("breathing_equipment");
    public static final TagKey<Item> AIR_REFILLER_ITEM_TAG = REGISTRY.registerItemTag("air_refiller");
