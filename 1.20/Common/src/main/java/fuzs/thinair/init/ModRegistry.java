...
public class ModRegistry {
    ...
    public static final ArmorMaterial RESPIRATOR_ARMOR_MATERIAL = ItemEquipmentFactories.registerArmorMaterial(REGISTRY.makeKey("respirator"), 6, new int[]{1, 1, 1, 1}, 15, () -> SoundEvents.ARMOR_EQUIP_GENERIC, 0, 0, () -> Ingredient.of(Items.CHARCOAL));
    ...
    public static final RegistryReference<Item> RESPIRATOR_ITEM = REGISTRY.registerItem("respirator", () -> new ArmorItem(RESPIRATOR_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
